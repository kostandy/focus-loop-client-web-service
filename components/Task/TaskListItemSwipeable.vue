...
<UCard
	...
	class="relative overflow-hidden w-full rounded-2xl"
>
	<div
	...
	<div
		...
		class="relative w-full h-full flex items-center p-4 sm:p-6 bg-gray-800 duration-500 ring-2 ring-gray-200 stroke-2 dark:ring-gray-800 select-none cursor-grab active:cursor-grabbing"
